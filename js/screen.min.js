...
NS_SocialCount.getTwCount=function(){$.ajax({type:"get",url:"https://cdn.api.twitter.com/1/users/show.json?screen_name=funradio_fr&callback=?",cache:!1,dataType:"jsonp",success:function(a,b,c){a=a.followers_count;b=a.toString();c=0;for(var d="",e=b.length-1;0<=e;e--)c++,d+=b[e],0===c%3&&b[e-1]&&(d+="."),a=d.split("").reverse().join("");NS_SocialCount.twCountElem.text(a);a=NS_SocialCount.twElem.html();NS_Global.vignette14.html(a);$(window).trigger("twCountReady")},error:function(){}})};
NS_SocialCount.showTwCount=function(){NS_SocialCount.twElem.addClass("show")};NS_SocialCount.hideSocialFrame=function(){NS_SocialCount.fbElem.removeClass("show");NS_SocialCount.twElem.removeClass("show")};var NS_LiveInfo=NS_LiveInfo||{};NS_LiveInfo.container=$("#live");
NS_LiveInfo.requester=function(){$.ajax({type:"get",url:"http://www.funradio.fr/video/live/en-direct",cache:!1,dataType:"html",success:function(a,b,c){NS_LiveInfo.container.empty();a=a.replace(/<script.*?<\/script>/gi,"");a=a.match(/.*<body.*>([\s\S]*)<\/body>.*/)[1];NS_LiveInfo.container.append(a);NS_LiveInfo.container.append($('<span class="what">LIVE</span>'));NS_Global.vignette15.html(a);NS_Global.vignette15.append($('<span class="what">LIVE</span>'));$(window).trigger("liveInfoReady")},error:function(){NS_LiveInfo.container.empty()}})};
